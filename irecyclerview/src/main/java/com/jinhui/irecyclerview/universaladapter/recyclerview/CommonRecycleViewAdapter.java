...
import com.jinhui.irecyclerview.animation.AlphaInAnimation;
import com.jinhui.irecyclerview.animation.BaseAnimation;
import com.jinhui.irecyclerview.bean.PageBean;
...
public abstract class CommonRecycleViewAdapter<T> extends RecyclerView.Adapter<ViewHolderHelper> implements DataIO<T> {
    ...
    @NonNull
    @Override
    public ViewHolderHelper onCreateViewHolder(@NonNull final ViewGroup parent, int viewType) {
