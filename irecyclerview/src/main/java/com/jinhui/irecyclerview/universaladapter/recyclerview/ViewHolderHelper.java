package com.jinhui.irecyclerview.universaladapter.recyclerview;
...
import com.jinhui.irecyclerview.utils.ImageLoaderUtils;
...
public class ViewHolderHelper extends RecyclerView.ViewHolder {
    ...
    public ViewHolderHelper setHighlightText(int viewId, SpannableString text) {
        TextView tv = getView(viewId);
        tv.setText(text);
        return this;
    }
    ...
    public ViewHolderHelper setImageUrl1(int viewId, String url) {
        ImageView view = getView(viewId);
        ImageLoaderUtils.display(mContext,view,url);
        return this;
    }
    ...
    public ViewHolderHelper setViewClickable(int viewId,boolean click){
        View view = getView(viewId);
    ...
    public ViewHolderHelper setWidth(int viewId,int width){
        TextView view = getView(viewId);
        view.setWidth(width);
        return this;
